...
CHPL_ENVS = [
    ...
    ChapelEnv('  CHPL_GPU_RUNTIME', RUNTIME | DEFAULT, 'gpu'),
    ChapelEnv('  CHPL_CUDA_PATH', RUNTIME | NOPATH),
    ChapelEnv('  CHPL_CUDA_LIBDEVICE_PATH', INTERNAL | NOPATH),
    ChapelEnv('  CHPL_LIBOMPTARGET_RTL', INTERNAL | NOPATH),
...
def compute_all_values():
    ...
    ENV_VALS['  CHPL_LIBOMPTARGET_RTL'] = chpl_gpu.get_libomptarget_rtl()
