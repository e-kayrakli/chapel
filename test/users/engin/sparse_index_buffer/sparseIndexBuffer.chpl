...
proc test(msg, d) {
  if bounded {
    ...
    var spsIndexBuffer = d.makeIndexBuffer();
    for i in indexGen(d) do
      spsIndexBuffer.add(i);
    spsIndexBuffer.commit();
  }
