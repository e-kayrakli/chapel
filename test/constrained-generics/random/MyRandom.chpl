/* 2021-05: this is a copy of modules/standard/Random.chpl as of c95d6a9e20
as a temporary convenience while developing the IC version of PCGRandomStream.

The changes here are:
* added the return type of skipToNth
  (this change should be made to the standard Random)
* removed 'private' on two randlc functions
  (this change is to be reverted once the code that depends on them
   - such as the IC implementation of fillRandom in this directory - is moved
   to the standard Random.chpl)
*/
