...
initPrimitive() {
  ...
  prim_def(PRIM_CHPL_COMM_GET_PBUF_ADDR, "chpl_comm_get_pbuf_addr", returnInfoCVoidPtr, true, true);
  ...
  prim_def(PRIM_ACQ_PBUF, "acquire_prefetch_buffer", returnInfoVoid, true, true);
