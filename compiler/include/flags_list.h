...
symbolFlag( FLAG_NO_LOCAL_RETURN, ypr, "no local return" , ncm )
...
symbolFlag( FLAG_WRAPPER_NEEDS_PBUF_ACQ , npr, "wrapper needs pbuf acq" , "add acquire_prefetch_buffer to the start of the wrapper function" )
