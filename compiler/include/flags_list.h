...
symbolFlag( FLAG_COMPILER_ADDED_AGGREGATOR , npr, "compiler added aggregator" , "marks aggregator symbols that the compiler added" )
...
symbolFlag( FLAG_IMPLEMENTS_WRAPPER, npr, "ImplementsStmt wrapper", ncm)
...
symbolFlag( FLAG_LOOP_EXPR_LEADER_ITER , npr, "loop expression leader" , ncm )
symbolFlag( FLAG_LOOP_EXPR_FOLLOWER_ITER , npr, "loop expression follower" , ncm )
symbolFlag( FLAG_LOOP_EXPR_SERIAL_ITER , npr, "loop expression serial iterator" , ncm )
