...
versions = [
    VersionType("synthInitPerf", "Manual", "", "b", "o", "solid"),
    VersionType("synthInitPerf", "Auto", "--prefetch", "g", "v", "solid"),
    VersionType("synthInitPerf", "Auto-Static", "--prefetch --staticDomain", "r", "^", "solid")]
